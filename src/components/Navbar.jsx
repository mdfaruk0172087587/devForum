...
const Navbar = () => {
    ...
    <div className="dropdown">
        <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-800 dark:text-gray-200" fill="none"
            ...
            <div className="navbar-end gap-3">
                ...
                {user ? (
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="mt-3 z-[1] p-3 shadow menu menu-sm dropdown-content bg-white  rounded-box w-48 space-y-2">
